...
Currently working on integrating ML Frameworks with the world's fastest AI accelerator @ Cerebras Systems.
...
- 🛠️ At Cerebras, I made significant contributions to open-source projects, such as [Torch-MLIR](https://github.com/llvm/torch-mlir) (supported by the LLVM Project and Google), and [PyTorch](http://github.com/pytorch/pytorch/).
